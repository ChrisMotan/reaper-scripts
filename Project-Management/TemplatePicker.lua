-- @description Project template picker with search bar
-- @author ChrisMotan
-- @version 1.0
-- @about
--   Browse and quickly load a REAPER project template.
--   Auto-detects the ProjectTemplates folder on Windows, macOS and Linux.
--   Requires ReaImGui.
-- ============================================================
